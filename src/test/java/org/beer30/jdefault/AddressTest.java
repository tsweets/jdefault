...
public class AddressTest {
    ...
    public void testBuildingNumber() throws Exception {
        String value = Address.buildingNumber();
        assertNotNull(value);
    ...
    public void testCityPrefix() throws Exception {
        String value = Address.cityPrefix();
        assertNotNull(value);
        assertTrue(value.length() >= 1);
        Assert.assertFalse(StringUtils.contains(value,"{"));
        Assert.assertFalse(StringUtils.contains(value,"#"));
    ...
    public void testCitySuffix() throws Exception {
        String value = Address.citySuffix();
        assertNotNull(value);
        assertTrue(value.length() >= 1);
        Assert.assertFalse(StringUtils.contains(value,"{"));
        Assert.assertFalse(StringUtils.contains(value,"#"));
    ...
    public void testLongitude() throws Exception {
        String value = Address.longitude();
        assertNotNull(value);
        assertTrue(value.length() >= 1);
        Assert.assertFalse(StringUtils.contains(value,"{"));
        Assert.assertFalse(StringUtils.contains(value,"#"));
    ...
    public void testSecondaryAddress() throws Exception {
        String value = Address.secondaryAddress();
        assertNotNull(value);
        assertTrue(value.length() >= 1);
        Assert.assertFalse(StringUtils.contains(value,"{"));
        Assert.assertFalse(StringUtils.contains(value,"#"));
    ...
    public void testStateAbbr() throws Exception {
        String value = Address.stateAbbr();
        assertNotNull(value);
        assertTrue(value.length() >= 1);
        Assert.assertFalse(StringUtils.contains(value,"{"));
        Assert.assertFalse(StringUtils.contains(value,"#"));
    ...
    public void testStateAbbrAll() throws Exception {
        String value = Address.stateAbbr(false);
        assertNotNull(value);
        assertTrue(value.length() >= 1);
    ...
    public void testStreetAddress() throws Exception {
        String value = Address.streetAddress();
        assertNotNull(value);
        assertTrue(value.length() >= 1);
        Assert.assertFalse(StringUtils.contains(value,"{"));
        Assert.assertFalse(StringUtils.contains(value,"#"));
    ...
    public void testStreetAddressWithSecondary() throws Exception {
        String value = Address.streetAddress(true);
        assertNotNull(value);
        assertTrue(value.length() >= 1);
        Assert.assertFalse(StringUtils.contains(value,"{"));
        Assert.assertFalse(StringUtils.contains(value,"#"));
    ...
    public void testStreetName() throws Exception {
        String value = Address.streetName();
        assertNotNull(value);
        assertTrue(value.length() >= 1);
        Assert.assertFalse(StringUtils.contains(value,"{"));
        Assert.assertFalse(StringUtils.contains(value,"#"));
    ...
    public void testStreetSuffix() throws Exception {
        String value = Address.streetSuffix();
        assertNotNull(value);
        assertTrue(value.length() >= 1);
        Assert.assertFalse(StringUtils.contains(value,"{"));
        Assert.assertFalse(StringUtils.contains(value,"#"));
    ...
    public void testZipCodeRandom() throws Exception {
        String value = Address.zipCode(true);
        assertNotNull(value);
        assertTrue(value.length() >= 1);
        Assert.assertFalse(StringUtils.contains(value,"{"));
        Assert.assertFalse(StringUtils.contains(value,"#"));
