 ...
 *         Time: 8:14 PM
 */
public class JDefaultCompanyTest {
    @Test
    public void testBs() throws Exception {
        String s = JDefaultCompany.bs();
    ...
    public void testCatchPhrase() throws Exception {
        String s = JDefaultCompany.catchPhrase();
        Assert.assertTrue(StringUtils.isNotEmpty(s));
    ...
    public void testDunsNumber() throws Exception {
        String s = JDefaultCompany.dunsNumber();
        Assert.assertTrue(StringUtils.isNotEmpty(s));
    ...
    public void testSuffix() throws Exception {
        String s = JDefaultCompany.suffix();
        Assert.assertTrue(StringUtils.isNotEmpty(s));
        System.out.println(s);
