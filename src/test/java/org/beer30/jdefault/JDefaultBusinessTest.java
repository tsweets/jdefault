 ...
 *         Time: 12:26 PM
 */
public class JDefaultBusinessTest {
    @Test
    public void testCreditCardExpiryDate() throws Exception {
        Date expDate = JDefaultBusiness.creditCardExpiryDate();
    ...
    public void testCreditCardType() {
        JDefaultCreditCardType ccType = JDefaultBusiness.creditCardType();
    ...
    public void testMoney() {
        Double money = JDefaultBusiness.money(200);
